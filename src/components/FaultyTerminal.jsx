/**
 * FaultyTerminal — WebGL 故障终端背景
 *
 * 来源:React Bits 组件库 (https://reactbits.dev)
 * 集成说明:src/components/FaultyTerminal.jsx + .css
 * 依赖:ogl (npm i ogl)
 *
 * 用途:在 Hero 区(欢迎语板块)作为绝对定位的 WebGL 背景
 *   - 用项目 accent 紫 (#7938eb) 作 tint
 *   - 数字字符飘动 + 扫描线 + 故障,营造"数字 / 收藏"主题感
 *   - 鼠标移动时数字会被吸引,提供轻量交互
 */
